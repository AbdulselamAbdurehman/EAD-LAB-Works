...
public class DBConnectionManager extends HttpServlet {
    ...
    private static final String createDatabaseQuery = "CREATE Database BookstoreDB;";
    private static final String createTableQuery = "CREATE TABLE Books( id INT AUTOINCREMENT PRIMARY KEY, title VARCHAR, author VARCHAR, price DOUBLE)";
    ...
    public void createTable(PrintWriter pw) {
        ...
        try {
            ...
            if (conn != null) {
                ...
                Statement statement = conn.prepareStatement(createTableQuery);
